...
module.exports.getOwnDeleteMessages = async function() {
  let path = join(process.cwd(), 'config.json');
  readFileSync(path, (err, data) => {
    if(err) return console.log(err);
    let jsondata = JSON.parse(data);
    return jsondata['deleteOwnMessages'] || false;
